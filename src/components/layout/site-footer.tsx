export function SiteFooter({ settings }: { settings: any }) {
    const { footerText, name, footerConfig } = settings || {}
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-slate-500 max-w-xs">
                            {config.description || "A modern content management system tailored for educational institutions."}
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="text-sm text-slate-600 whitespace-pre-line">
                            {config.contact || "Jl. Kampus Merdeka No. 123\nJakarta, Indonesia\ninfo@kampus.ac.id"}
                        </div>
                    </div>
                </div>
